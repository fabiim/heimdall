...
package net.floodlightcontroller.devicemanager.original.internal;

import static net.floodlightcontroller.devicemanager.original.internal.DeviceManagerImpl.DeviceUpdate.Change.ADD;
import static net.floodlightcontroller.devicemanager.original.internal.DeviceManagerImpl.DeviceUpdate.Change.CHANGE;
import static net.floodlightcontroller.devicemanager.original.internal.DeviceManagerImpl.DeviceUpdate.Change.DELETE;
...
import net.floodlightcontroller.devicemanager.original.IDevice;
import net.floodlightcontroller.devicemanager.original.IDeviceListener;
import net.floodlightcontroller.devicemanager.original.IDeviceService;
import net.floodlightcontroller.devicemanager.original.IEntityClass;
import net.floodlightcontroller.devicemanager.original.IEntityClassListener;
import net.floodlightcontroller.devicemanager.original.IEntityClassifierService;
import net.floodlightcontroller.devicemanager.original.SwitchPort;
import net.floodlightcontroller.devicemanager.original.internal.DeviceSyncRepresentation.SyncEntity;
...
IFlowReconcileListener, IInfoProvider {
     ...
     * objects.
     */
    protected IKeyValueTable<Long, Device> deviceMap;
    ...
    protected static class ClassState {
         ...
         * The class index
         */
        protected net.floodlightcontroller.devicemanager.original.internal.DeviceUniqueIndex classIndex;
    ...
    public void addIndex(boolean perClass,
        ...
        if (perClass) {
            ...
            secondaryIndexMap.put(keyFields,
                                  new net.floodlightcontroller.devicemanager.original.internal.DeviceMultiIndex(keyFields));
        }
    }
    ...
    protected Device learnDeviceByEntity(Entity entity) {
        ...
        while (true) {
            ...
            if (deviceKey != null) {
                ...
                deviceKey = (long) proxy.getAndIncrement(deviceMap.getName(), "DM_ID");
            ...
            if ((entityindex = device.entityIndex(entity)) >= 0) {
                ...
                if (!deviceMap.replace(device.getDeviceKey(), oldDevice, device)){
                	continue; 
                }
